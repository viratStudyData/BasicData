...
- (void)configureViewForAlertType:(ISAlertType)alertType iconImage:(UIImage*)iconImage {
    ...
    switch (alertType) {
        ...
        case ISAlertTypeError: {
            self.alertViewBackgroundColor = [UIColor colorWithRed:208.f/255.f green:2.f/255.f blue:27.f/255.f alpha:1.f];
            if (!_iconImage) {
...
//        }
        case ISAlertTypeInfo: {
            self.alertViewBackgroundColor =  [UIColor colorWithRed:38.f/255.f green:38.f/255.f blue:38.f/255.f alpha:4.f/5.f];
            if (!_iconImage) {
                self.iconImage = [self imageNamed:@"isInfoIcon"];
            }
            break;
